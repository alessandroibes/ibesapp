...
export function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      className={cn("ds-menu-item", inset && "ds-menu-inset", className)}
      {...props}
    />
  );
}
export function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      className={cn("ds-menu-label", inset && "ds-menu-inset", className)}
      {...props}
    />
  );
}
...
export function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      className={cn("ds-menu-item ds-menu-check", className)}
      checked={checked}
      {...props}
    >
